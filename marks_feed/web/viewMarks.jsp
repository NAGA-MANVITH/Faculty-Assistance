<%-- 
    Document   : viewMarks
    Created on : Apr 6, 2017, 2:04:08 PM
    Author     : Vasishta
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" id="printLayout">
            <div class="container-fluid" id="marksTable">
            
            </div>
        </div>
        <div class="container-fluid" style="display: none;" id="printButton">
            <div class="row">
                <div class="col-md-3">
