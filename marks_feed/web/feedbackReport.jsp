<%-- 
    ...
    Created on : Apr 3, 2017, 9:51:19 PM
    Author     : Vasishta
--%>
...
Class.forName("com.mysql.jdbc.Driver");
    ...
    if ((session.getAttribute("fac_id") != null)&&(faclevel.equals("2"))) {
        ...
        response.sendRedirect("new.html"); //else redirection page(should be created) checking is done in third table
    }
%>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <button class="btn btn-primary" onclick="getFacultyReport()">Submit</button>
                </div>
            </div>
        </div>
        <div class="container-fluid" id="totalNoofFeedbacks">
            
        </div>
        <div class="container-fluid" id="noFeedbacks">
            
        </div>
        <div class="container-fluid" id="printLayout" style="display: none;">
            <div class="container-fluid" id="facultyDetails">
                <div class="row">
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facultyName"></h4></div>
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facDesignation"></h4></div>
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facClass"></h4></div>
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facYear"></h4></div>
                </div>
                <div class="row">
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facSemester"></h4></div>
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facSection"></h4></div>
                    <div class="col-md-2 col-lg-2 col-xs-2 col-sm-2"><h4 id="facSubject"></h4></div>
                </div>
                
            </div>
            <div class="container-fluid" id="facultyFeedbackReport">

            </div>
            <div class="container-fluid" id="signatureDiv" style="display: none; float: right; margin-top: 18%; margin-right: 10%;">
                <strong>Signature of the faculty</strong>
            </div>
            <div class="container-fluid" id="ratingDiv" style="display: none; margin-top: 5%;">
                
            </div>
            <div class="container-fluid" id="commentsDiv" style="display: none;">
                
            </div>
        </div>
        <div class="container-fluid" style="font-size: 24px; display: none; margin-top: 20px;" id="printFacultyButton">
            <div class="row">
                <div class="col-md-3">
                    <button class="btn btn-primary" onclick="printDiv('printLayout')">Print</button>
                </div>
            </div>
        </div>
    </body>
