...
public class Servlet15 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ResultSet rs = statement.executeQuery("SELECT DISTINCT b.reg_no FROM secondtable a,studentstatus_tmp b,feedback_store c WHERE a.branch='"+branch+"' AND b.semester='"+semester+"' AND a.sub_code='"+subject+"' AND b.section='"+section+"' AND a.fac_id='"+fac_id+"' AND b.reg_no NOT IN (SELECT student_id FROM feedback_store WHERE feedback_no='" + feedback_no + "')");
            List<String> list = new ArrayList<String>();
            while(rs.next()){
                list.add(rs.getString("b.reg_no"));
            }                             
