    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           Class.forName("com.mysql.jdbc.Driver");
            ...
            String query = "SELECT fac_name FROM secondtable a join thirdtable b on a.fac_id=b.fac_id WHERE accdyear='" + acad_year + "' AND semester='" + semester + "' AND sub_code='" + sub_code + "'";
