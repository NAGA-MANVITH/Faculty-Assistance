    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            String query = "SELECT regulation FROM students_tmp WHERE reg_no='" + reg_no + "'";
            ResultSet rs = (ResultSet) statement.executeQuery(query);
            rs.next();
            String regulation = rs.getString("regulation");
            String query_1 = "SELECT co1, co2, co3, co4, co5 FROM semwisesubject WHERE regl_no='" + regulation + "' AND sub_code='" + sub_code + "'";
            ResultSet res = (ResultSet) statement_1.executeQuery(query_1);
            List<String> list = new ArrayList<String>();
            JSONObject obj = new JSONObject();
            res.next();
            for(int i = 1; i <= 5; i++) {
                obj.put("co" + i, res.getString("co" + i));
            }
