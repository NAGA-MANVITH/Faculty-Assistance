...
public class Servlet16 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "SELECT distinct assesment_type, assesment_number FROM internal_marks WHERE acad_year='" + acad_year + "' AND branch='" + branch + "' AND semester='" + semester + "' AND subject='" + subject + "' AND section='" + section + "' AND fac_id='" + fac_id + "' AND program='" + program + "'";
