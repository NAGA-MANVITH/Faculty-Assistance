        ...
        <script>
            ...
            $('#semester').change(function(event) {
                ...
                $('#assesmentType').change(function() {
                   ...
                   if(type == 'test') {
                       document.getElementById('assesmentMethodDiv').style.display = 'none';
                       ...
                       document.getElementById('assesmentMethodDiv').style.display = 'block';
                       document.getElementById('othersBox').style.display = 'none';
                       $('#assesmentNumber').empty();
                       $('#assesmentNumber').append('<option value=1>1</option><option value=2>2</option><option value=3>3</option><option value=4>4</option>');
                   }
                });
                $('#assesmentMethod').change(function() {
                    if(document.getElementById('assesmentMethod').value == "Others") {
                        document.getElementById('othersBox').style.display = 'block';
                    }
                });
            });
        </script>
        <title>Create Schema and Post Marks</title>
    </head>
    <body>
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="assesmentMethodDiv">
                        <label for="assesmentMethod" style="margin-top: 10px;">Assessment Method</label>
                        <select id="assesmentMethod" class="form-control">
                            <option value="Assignment">Assignment</option>
                            <option value="Quiz">Quiz</option>
                            <option value="Term Paper">Term Paper</option>
                            <option value="Tutorial">Tutorial</option>
                            <option value="Surprise Test">Surprise Test</option>
                            <option value="Open Book Test">Open Book Test</option>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <button class="btn btn-primary" id="submit" onclick="askForSchema()">Submit</button>
                    </div>
                </div>
            </div>
            <div class="container-fluid" id="createSchemaDiv">
                
            </div>
            <div class="container-fluid" id="postMarksDiv">
